                ...
                <?php if ($no_such_review == false) { ?>
                    ...
                    <form id="editReviewForm" method="post" action="update_review.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-text-char-count-input" maxlength="40" name="review_name" value="<?php echo htmlspecialchars($row['review_name']); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-text-char-count-input" maxlength="300" name="review_desc" rows="4"><?php echo htmlspecialchars($row['review_desc']); ?></textarea>
