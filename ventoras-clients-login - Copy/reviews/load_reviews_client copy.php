                    ...
                    <div id="carouselExampleIndicators2" class="carousel slide" data-bs-interval="false">
                        ...
                        <div class="carousel-inner">
                            ...
                            ?>
                                                ...
                                                <div class="num-item-cell-div">
                                                    <div class="num-item-cell-top-sec">
                                                        <div class="display-flex">
                                                            <div class="review-profile-pic" style="background-image: url(' <?php if ($all_results[$i]['review_profilepicture'] == '') {
                                                                                                                                echo  $PROFILE_PICTURE_LINK_BASE . $DEFAULT_PROFILE_PICTURE_BG_IMAGE;
                                                                                                                            } else {
                                                                                                                                echo $PROFILE_PICTURE_LINK_BASE . $all_results[$i]['review_profilepicture'];
                                                                                                                            } ?>');">
                                                            </div>
                                        ...
                                        //if this isn't the last item, then print the next review [$i + 1]
                                            ...
                                            <div class="col-md-6">
                                                <div class="num-item-cell">
                                                    <div class="num-item-cell-div">
                                                        <div class="num-item-cell-top-sec">
                                                            <div class="display-flex">
                                                                <div class="review-profile-pic" style="background-image: url(' <?php if ($all_results[$y]['review_profilepicture'] == '') {
                                                                                                                                    echo  $PROFILE_PICTURE_LINK_BASE . $DEFAULT_PROFILE_PICTURE_BG_IMAGE;
                                                                                                                                } else {
                                                                                                                                    echo $PROFILE_PICTURE_LINK_BASE . $all_results[$y]['review_profilepicture'];
                                                                                                                                } ?>');">
                                                                </div>
                                                                <div class="review-profile-name">
                                                                    <h4><?php echo $all_results[$y]['review_name']; ?></h4>
                                                                    <p>Written on <?php $timestamp = strtotime($all_results[$y]['review_date']);
                                                                                    $day = date('j', $timestamp);
                                                                                    $suffix = date('S', $timestamp);
                                                                                    $month = date('F', $timestamp);
                                                                                    $year = date('Y', $timestamp);
                                                        ...
                                                        <p class="reviews-desc limited-text" data-full-review="<?php echo $all_results[$y]['review_desc']; ?>"><?php echo $all_results[$y]['review_desc']; ?>
                                                            <!-- <b class='review-view-more' style="color:blue; font-weight: 400;">Read More</b> -->
                                                        </p>
                                                    </div>
                                                </div>
