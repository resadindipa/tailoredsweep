                ...
                <?php if ($no_such_project == false) { ?>
                    ...
                    <form id="editReviewForm" method="post" action="update_review.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-text-char-count-input" maxlength="50" name="project_title" value="<?php echo htmlspecialchars($row['project_title']); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="project_desc" class="form-control form-text-char-count-input" maxlength="300" id="project_desc"><?php echo htmlspecialchars($row['project_desc']); ?></textarea>
